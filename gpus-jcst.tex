...
\begin{abstract}
Evolutionary Algorithms (EAs) have been widely adapted to General
Purpose Graphics Processing Units (GPGPUs), as they are inherently
parallel population-based approaches. Different methodologies and
...
implementations.
Thus, an extended sample of the publications have been
...
operations. % Is this done finally?
\end{abstract}
...
Latest works are based on more complex evolutionary processes. Algorithms, such as the SCE-UA, that can be deteriorated performance when dealing with complex models and big data, can benefit from the combination of multi-core CPUs and many-core GPUS. In \cite{Kan17SCEUA} the SCE-UA algorithm was improved by the use of heterogeneous parallel computing. This algorithm is a more complex process of evolution of solutions, being conformed by several steps: combination of probabilistic and deterministic  approaches, clustering, systematic evolution of a complex of points spanning the space, and competitive evolution.
