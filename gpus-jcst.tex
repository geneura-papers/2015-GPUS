...
Evolutionary algorithms \cite{de2016evolutionary} is a biologically inspired class of algorithms that, in general, evolve a set of solutions (usually called a {\em population}
...
Instruction Multiple Data (SIMD)\cite{Pharr12SPMD} architectures.
