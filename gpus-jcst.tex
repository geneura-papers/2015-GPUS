...
\begin{abstract}
Evolutionary Algorithms (EAs), a population based approach to problem solving, 
...
or as a Single Instruction Multiple Data (SIMD) model \cite{Pharr12SPMD}.
Their use in all kind of computers propitiated the development of 
