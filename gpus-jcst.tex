...
using GPUs for General Purpose computing. These aspects normally
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Parallelizing metaheuristics on GPGPUs}
...
libCudaOptimzie \cite{nashed2012libcudaoptimize}, although it does not
