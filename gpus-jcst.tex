...
In principle, the best approach for this kind of paralellization would
be to create frameworks for performing it. Frameworks put a layer of abstraction over the specifics of GPU
