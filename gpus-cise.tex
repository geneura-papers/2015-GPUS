...
The most complete and comprehensive review of these frameworks is from Parejo \cite{springerlink:10.1007/s00500-011-0754-8}. It is a comparative study of metaheuristic optimization frameworks. As criteria for comparison, a set of 271 features grouped in 30 characteristics and 6 areas has been selected. These features include the different metaheuristic techniques covered, mechanisms for solution encoding, constraint handling, neighborhood specification, hybridization, parallel and distributed computation, software engineering best practices, documentation and user interface. However, out of ten most extended EA frameworks (ECJ, ParadisEO, Eva2, FOM, jCLEC, OAT, Opt4j, EasyLocal, HeuristicLab and MALLBA), none included references to GPU capabilities when this paper was published.

But in the recent years, some of these frameworks have included some GPU  

PARADISEO

Some authors have created library extensions to existing frameworks to allow the evaluation of the individuals in GPUs, for example Robiliard et al. \cite{RobilliardECJGPU08} for ECJ, and Cano et al. for jCLEC \cite{CanoJCLECGPU12}.
