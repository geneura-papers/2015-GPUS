...
% Are you going to compare it with other metaheuristics? - JJ
% Antonio - I have fixed it
...
% composed by -> lo que hacen los compositores - JJ
% Antonio - ok
...
% "also" should be avoided. Use some logical particle. "after
