...
Selection 	    & Fitness proportional 	          & Random 				      & Random			          & Fitness proportional & Random to create noisy vectors \\ \hline
...
% Antonio - Great, but please comment also the works by Meri et al. (Meri_CloudEA13 in BIB) and Merelo et al. (Merelo_Couch13).
However, with the advent of new
technologies, new evolutionary approaches have been proposed that take into account, for instance, the unreliability of millions of nodes co-operating in P2P \cite{laredo2010evag} or the data-intensive computing frameworks, used in cloud computing \cite{VermaCloud10}.
