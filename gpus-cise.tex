...
schemes for EAs. % distributed != parallel ~ JJ
...
category. % How did you select it? - JJ
But previously, the work revises the new advances in hardware and
software in this field, and gives an introduction on how to
parallelize EA algorithms on GPGPUs, describing both several
frameworks which allow to do it easily, and the main issues to have
into account for these implementations.  % Structure this abstract
                                % better, avoiding things like
                                % "previously"- JJ
\end{abstract}
