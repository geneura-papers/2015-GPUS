...
\item[Genetic Programming] The objective of this technique is to
  ...
  been used to evolve LISP (LISt Processing) programs
  \cite{Koza1990Tools}, or XSLT (eXtensible Stylesheet
...
based on the concept of {\em meme} 
proposed by Dawkins
...
codify a set of rules, as proposed by Smith \cite{smith2002co}
