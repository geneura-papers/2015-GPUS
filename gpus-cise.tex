...
The paper also presents a review of advances in hardware and software along with new trends in the field. % This probably should go higher in the abstract - JJ
% Antonio  - right
...
%The analysis shows this as a very prolific research area. % The analysis shows this? How? The number of papers is the one that would show prolificness or not - JJ
% Antonio - wrong sentence I think
...
eventually, the quality of the solutions is improved. These algorithms
...
\includegraphics[width=0.5\textwidth,trim={1.5cm 1.5cm 1.5cm 1.5cm},clip]{papertype.eps}
...
\begin{figure*}[!ht]
\centering
\includegraphics[width=0.5\textwidth,trim={1.5cm 1.5cm 1.5cm 1.5cm},clip]{algorithmtype.eps}
...
\begin{figure*}[!ht]
\centering
\includegraphics[width=0.5\textwidth,trim={1.5cm 1.5cm 1.5cm 1.5cm},clip]{realproblem.eps}
