...
Data storage and communication within a device and between devices, mainly CPU and GPU, is dictated by the memory model. 

\begin{figure*}[!ht]
\centering
\includegraphics[width=0.98\textwidth]{memory.eps}
