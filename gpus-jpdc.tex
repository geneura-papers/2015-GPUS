...
\address{Periodista Daniel Saucedo Aranda, s/n \\ E18071 Granada (Spain) \\ University of Granada}
...
\begin{keyword}
parallel computation \sep evolutionary algorithms \sep metaheuristics \sep GPUs \sep GPGPUs \sep survey \sep review
\end{keyword}
