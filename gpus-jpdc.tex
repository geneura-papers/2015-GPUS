...
\title{Parallel Computation of Evolutionary Algorithms on GPUs}
...
\author{Gustavo Romero} \ead{gustavo@ugr.es}
...
\address{Periodista Daniel Saucedo Aranda, s/n \\ 18014 Granada \\ University of Granada}
...
\begin{keyword}
parallel computation \sep evolutionary algorithms \sep metaheuristics \sep GPUs \sep GPGPUs survey \sep review
\end{keyword}
