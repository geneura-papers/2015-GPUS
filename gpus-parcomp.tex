...
%TODO mirad si el t�tulo est� bien
...
% Antonio - TODO: incluir aqu� alguna conclusi�n
The paper also presents a review of hardware and software advances in these trends.
% Todo lo de arriba es la motivación del trabajo, no la del paper. Debería ir a la intro. En el abstract debéis decir qué se hace en el paper - JJ
% creo que JJ tiene razón pero a lo mejor lo podemos dejar un poco más cortito - gustavo
% Antonio - lo he cambiado, espero que est� mejor. ;)
\end{abstract}
...
%algoritmos bioinspirados. Es una revista generalista y tendr�ais que
%hacerlo - JJ
...
higher level programming languages used to profit GPUs. Section \ref{sec:taxonomy} proposes a taxonomy to differentiate between all the papers. %TODO describir mejor esta sección
Finally,
...
\citep{Buck:2004:BGS:1015706.1015800}.  % Esto debería ir en la intro - JJ
...
\section{Survey on Evolutionary Algorithms on GPUs} %TODO poner un título mejor
\label{sec:survey}
...
%%TODO AQUI VAN LOS GRÁFICOS DE JJ
