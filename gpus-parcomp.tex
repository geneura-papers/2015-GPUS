...
algorithms, a subfield of artificial inteligence who is specially suited to paralelization. Thus, the work proposes a taxonomy of the actual parallelization methods in GPUs, along with a review of the literature in this area.
\end{abstract}
