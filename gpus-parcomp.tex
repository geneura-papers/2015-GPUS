...
these algorithms have been executed in one more central processing units
(CPUs) each one with one or many cores. % esa frase es un poco superflua, pero la he corregido - JJ
% No se usan saltos de párrafo en el abstract - JJ
...
The GPUs, alone or in conjunction with CPUs, will in many cases offer better results % results or performance - JJ
