...
\hline
Intel Xeon E7 8890 V3   & 5.69          & 662          & 18            & 2.5        & 102          & 1500           & 155 & 6000   \\
...
This section proposes a taxonomy to distinguish between all possible distribution methods used in the literature. %TODO TERMINAR
...
\subsection{Taxonomy}
This taxonomy is based on the classical approach followed by other authors, but it adds two new groups: the hierarchical and the non-standard models. %TODO TERMINAR
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\section{Survey on Evolutionary Algorithms on GPUs} %TODO poner un tÃ­tulo mejor
\section{Research review} % que tal este? - gustavo
\label{sec:survey}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\subsection{Collection technique} % que tal este? - gustavo
