...
is applied to solve real problems. Thus, we have defined a taxonomy of
...
Finally, the majority of the analysed publications deal with real problems solving as it is presented in Figure \ref{figure:type_problem}. This means that the parallelization by means of GPUs is very effective and can be used in relevant problems.
